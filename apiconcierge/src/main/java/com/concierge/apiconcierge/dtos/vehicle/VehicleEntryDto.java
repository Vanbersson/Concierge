...
public record VehicleEntryDto(
        ...
        byte[] photo3,
        byte[] photo4,
        @NotNull Integer quantityExtinguisher,
        @NotNull Integer quantityTrafficCone,
        @NotNull Integer quantityTire,
        @NotNull Integer quantityTireComplete,
        @NotNull Integer quantityToolBox,
